...
const documentedReleaseVersion = "0.4.3";
...
describe("release version", () => {
  it("uses 0.4.3 as the package and verified manifest version", () => {
  ...
  it("names the 0.4.3 archive in build documentation", () => {
  ...
  it("keeps the current Store archive reference at 0.4.3", () => {
